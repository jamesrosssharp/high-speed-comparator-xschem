...
N 100 -200 100 -180 {lab=VDD}
N 250 -200 250 -180 {lab=VDD}
N 60 -110 100 -110 {lab=VOUT_PLUS}
N -100 -110 -20 -110 {lab=VOUT_MINUS}
N -20 -60 20 -20 {lab=VOUT_MINUS}
N 20 -20 60 -20 {lab=VOUT_MINUS}
N -120 -80 -100 -80 {lab=VOUT_MINUS}
N 20 -110 60 -110 {lab=VOUT_PLUS}
N -20 -20 20 -60 {lab=VOUT_PLUS}
N -60 -20 -20 -20 {lab=VOUT_PLUS}
N 100 -80 130 -80 {lab=VOUT_PLUS}
N -20 -110 20 -150 {lab=VOUT_MINUS}
N 20 -150 60 -150 {lab=VOUT_MINUS}
N -20 -150 20 -110 {lab=VOUT_PLUS}
N -60 -150 -20 -150 {lab=VOUT_PLUS}
N -100 -100 -100 -50 {lab=VOUT_MINUS}
N 100 -100 100 -50 {lab=VOUT_PLUS}
N 20 -60 100 -60 {lab=VOUT_PLUS}
N -100 -60 -20 -60 {lab=VOUT_MINUS}
N -250 -120 -250 -110 {lab=VOUT_MINUS}
N -250 -110 -100 -110 {lab=VOUT_MINUS}
N 100 -110 250 -110 {lab=VOUT_PLUS}
...
C {opin.sym} 130 -80 0 0 {name=p7 lab=VOUT_PLUS}
C {opin.sym} -120 -80 0 1 {name=p8 lab=VOUT_MINUS}
