...
N 110 -100 150 -100 {lab=net3}
N 150 -150 150 -100 {lab=net3}
N 150 -150 320 -150 {lab=net3}
N 230 -100 510 -100 {lab=VGN_PLUS}
N 360 -70 510 -70 {lab=VGN_MINUS}
N -230 -120 -220 -120 {lab=VSS}
N -310 -120 -230 -120 {lab=VSS}
N -310 -120 -310 80 {lab=VSS}
...
spiceprefix=X
mult=1}
C {lab_wire.sym} 30 -10 0 0 {name=p8 sig_type=std_logic lab=net1}
C {lab_wire.sym} -40 -130 0 0 {name=p9 sig_type=std_logic lab=net2}
C {lab_wire.sym} 210 -150 0 0 {name=p10 sig_type=std_logic lab=net3}
C {sky130_fd_pr/nfet3_01v8_lvt.sym} -60 -60 0 0 {name=M5
W=10
L=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet3_01v8_lvt.sym} 130 -60 0 1 {name=M6
W=10
L=1
nf=1
mult=1
