...
N -380 110 -140 110 {lab=#net1}
N -380 110 -380 310 {lab=#net1}
N -420 310 -280 310 {lab=#net1}
...
C {devices/vsource.sym} -570 90 0 0 {name=VPLUS value="SIN(0.9 0.02 1500k)"
spice_ignore=false}
...
C {lab_wire.sym} -520 310 0 0 {name=p2 sig_type=std_logic lab=VIN}
